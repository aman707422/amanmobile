    ...
    save.addEventListener("click",
        function (e) {
            ...
            if (key == "" || value == "") {
                ...
                let w_confirm = window.confirm("LocalStorageに" + key + " " + value + "データを保存しますか？");
                if (w_confirm === true) {
    ...
    del.addEventListener("click",
        function (e) {
            ...
            if (w_sel === "1") {
                const key = document.getElementById("textKey").value;
                const value = document.getElementById("textMemo").value;
                let w_confirm = window.confirm("LocalStorageから" + key + " " + value + "のデータを削除しますか?");
                if (w_confirm === true) {
...
function selectCheckBox() {
    ...
    if (w_cnt === 1) {
        ...
        w_sel="0";
        window.alert("1 つ選択 (select) してください。");
    }
    return w_sel;
};
